...
%%% Single-row equation
%
Let $C[0]_{pf}$ be the initial size of the permafrost C pool (Pg C) and $\Phi[t]$ be the fraction of permafrost remaining (in arbitrary area or volume units) at time $t$. text is here. this is more text. more text is here.  text is here. this is more text $a_b$. More text is here.  text is here. this is more text. more text is here.  text is here. this is more text. more text is here.  text is here. this is more text $a_b$. The C consequences of permafrost thaw can therefore be represented as:
\begin{equation}
y = 5
\end{equation}

more text is here.  text is here. this is more text. more text is here.  text is here. this is more text. more text is here.  text is here. this is more text
\begin{align}
& 3 + 5 = 8\\
& 3 + 5 = 8\\
& 3 + 5 = 8
